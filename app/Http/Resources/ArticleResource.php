    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'featured_image'   => $this->featuredImage ? [
                ...
                'webp_path' => $this->featuredImage->webp_path ?? $this->featuredImage->path,
            ...
            // البيانات المنظمة الخاصة بـ Google (Schema.org / JSON-LD)
            'schema_markup'    => [
                '@context'         => 'https://schema.org',
                '@type'            => $this->schema_type ?? 'NewsArticle',
                'headline'         => $this->title,
                'description'      => $this->meta_description ?? $this->excerpt,
                'image'            => $this->featuredImage ? [$baseUrl . '/' . ltrim($this->featuredImage->path, '/')] : [],
                'datePublished'    => $this->published_at ? $this->published_at->toAtomString() : $this->created_at?->toAtomString(),
                'dateModified'     => $this->updated_at ? $this->updated_at->toAtomString() : $this->created_at?->toAtomString(),
                'mainEntityOfPage' => [
                    '@type' => 'WebPage',
                ...
                'author'           => [
                    '@type' => 'Person',
                    'name'  => $this->author->display_name ?? $this->author->name ?? 'المحرر',
                ],
                'publisher'        => [
                    '@type' => 'Organization',
